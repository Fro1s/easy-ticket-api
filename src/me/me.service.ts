...
export class MeService {
  ...
  async listTickets(
    ...
    const rows = await qb
      .select([
        ...
        't.holderName AS t_holder_name',
        't.holderEmail AS t_holder_email',
        'e.id AS e_id',
        'e.slug AS e_slug',
        'e.title AS e_title',
    ...
    const items = rows.map((r) => ({
      ...
      holderName: r.t_holder_name ?? null,
      holderEmail: r.t_holder_email ?? null,
      event: {
        id: r.e_id,
        slug: r.e_slug,
        title: r.e_title,
  ...
  async findTicket(userId: string, ticketId: string): Promise<MyTicketItem> {
    ...
    return {
      ...
      holderName: row.t_holder_name ?? null,
      holderEmail: row.t_holder_email ?? null,
      event: {
        id: row.e_id,
        slug: row.e_slug,
        title: row.e_title,
