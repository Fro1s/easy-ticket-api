...
export class AddProcessingFeeToOrders1777800100000 implements MigrationInterface {
  public async up(q: QueryRunner): Promise<void> {
    await q.query(
      `ALTER TABLE "orders" ADD COLUMN "processingFeeCents" integer NOT NULL DEFAULT 0`,
    );
    await q.query(
      `ALTER TABLE "orders" ADD COLUMN "processingFeeMethod" "public"."orders_paymentmethod_enum" NULL`,
    );
  }
